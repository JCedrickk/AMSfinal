...
# =============================================
# IMPORTANT: Create startup script to run migrations
# =============================================
RUN echo '#!/bin/bash\n\
...
php artisan db:seed --class=CourseSeeder --force || true\n\
...
# Use the startup script instead of running apache directly
